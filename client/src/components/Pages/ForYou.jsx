      ...
      try {
        ...
        if (data.message === 'Products fetched successfully') {
          ...
          const formattedProducts = data.products.map(product => ({
            ...
            weight: product.SIH || 'N/A', // Use SIH as weight or fallback to N/A
            color: product.variations?.[0]?.Colour || 'N/A', // Use first variation color or fallback
            size: product.variations?.[0]?.Size || null // Use first variation size or null
          }));
