    ...
    >
      <div className="relative mt-2">
        <img 
          src={image} 
          alt={title} 
          className="w-[220px] h-[170px] object-cover cursor-pointer"
      ...
      <div className="mt-4">
        ...
        <h3 
          className="text-[13.33px] font-medium text-gray-700 leading-snug text-[#1D372E] line-clamp-2 overflow-hidden pl-4 cursor-pointer"
          onClick={onProductClick}
        >
          {title}
        </h3>
