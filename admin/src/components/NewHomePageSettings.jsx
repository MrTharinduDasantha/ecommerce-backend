...
const NewHomePageSettings = ({ onNext, isLoading: externalLoading }) => {
  ...
  const togglePreview = () => {
    if (!showPreview) {
      if (canShowPreview()) {
        ...
        toast.error("Please fill in all required fields before viewing the preview");
      }
    } else {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      if (onNext) {
        onNext(); // Proceed to the next step (policy)
      }
    } catch (error) {
            ...
            <div className="mb-8">
              ...
              <div className="form-control">
                ...
                <input
                  ...
                  disabled={!isEditing || externalLoading}
                />
